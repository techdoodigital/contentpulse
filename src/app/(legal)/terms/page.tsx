export const metadata = {
  title: "Terms of Service - ContentPulse",
  description: "ContentPulse terms of service covering usage, subscriptions, and liability.",
};
    ...
    <div className="prose prose-invert prose-slate max-w-none">
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          ContentPulse is a content health monitoring tool that connects to your
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          To use ContentPulse, you must sign in with a Google account that has
          access to Google Search Console properties. You are responsible for
          maintaining the security of your Google account. ContentPulse
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          You agree to use ContentPulse only for monitoring websites you own or
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          ContentPulse offers Free, Starter, and Pro subscription tiers. Paid
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          You retain all rights to your data. ContentPulse does not claim
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          ContentPulse uses AI models to generate decay analysis and
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          ...
          service. ContentPulse depends on third-party services (Google Search
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          ContentPulse is provided "as is" without warranty of any kind. We are
